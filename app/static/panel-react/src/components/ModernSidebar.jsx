...
export function ModernSidebar() {
  ...
  return (
    <div className={cn(
      "fixed left-0 top-0 flex h-screen flex-col border-r border-slate-200 bg-white/85 backdrop-blur-md transition-all duration-300 dark:border-slate-800 dark:bg-slate-950/75",
      collapsed ? "w-16" : "w-64"
    )}>
      {/* Logo */}
